...
-- inv is a number that is consant when the overall_ranking and rk are increasing at the same rate, when rk resets, 
-- inv changes and then remains constant for the rest of the interval. 
-- using the difference between the global rank and the relative rank to form a group id
