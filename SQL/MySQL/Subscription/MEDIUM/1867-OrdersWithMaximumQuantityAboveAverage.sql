...
max(avg(quantity)) over() as max_avg_qty,
case
when max(quantity)>max(avg(quantity)) over() then 'imbalanced'
else 'ok'
end
as category
from ordersdetails
...
| order_id | product_id | quantity | average_quantity | max_quantity | max_avg_qty | category   |
| -------- | ---------- | -------- | ---------------- | ------------ | ----------- | ---------- |
| 1        | 1          | 12       | 12.3333          | 15           | 14.3333     | imbalanced |
| 2        | 1          | 8        | 5.5              | 8            | 14.3333     | ok         |
| 3        | 3          | 5        | 14.3333          | 20           | 14.3333     | imbalanced |
| 4        | 5          | 2        | 5                | 8            | 14.3333     | ok         |
| 5        | 7          | 9        | 9                | 9            | 14.3333     | ok         |
